                                    ...
                                    <table class='table table-striped table-hover' width="100%">
                                        ...
                                        while ($dadosRedes = mysqli_fetch_array($resultRedes)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="a2"
                                                       href="single-listing.php?id=<?php echo $dadosRedes['estabelecimentoId'] ?>">Ver
                                                </td>
                                                </a>
                                            </tr>
                                            <?php
                                            ...
                                            if ($_SESSION['id'] == $id) {
                                                ...
                                                while ($dadosEstabelecimentos = mysqli_fetch_array($resultEstabelecimentos)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="a2"
                                                               href="criado.php?id=<?php echo $dadosEstabelecimentos['estabelecimentoId'] ?>">Ver
                                                        </td>
                                                        </a>
                                                    </tr>
                                                    <?php
                            ...
                            <div class="reviews-item">
                                <div class="rating">
                                    ...
                                    while ($dadosRating = mysqli_fetch_array($resultRating)) {
                                        ?>
                                        <h5 class="mt-3"><a
                                                    href="single-listing.php?id=<?php echo $dadosRating['estabelecimentoId'] ?> "> <?php echo $dadosRating['estabelecimentoNome'] ?></a>
                                        </h5>
