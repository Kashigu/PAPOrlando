...
function editaUtilizador(id) {  // abre o modal e injecta o ID
...
function EditarTableUtilizador() {
    $.ajax({
        url: "../AJAX/AJAXEditUtilizador.php",
        type: "post",
        data: {
            perfilNome: $('#perfilNome').val(),
            perfilId: $('#perfilId').val(),
            perfilEmail: $('#perfilEmail').val(),
            perfilLocalidade: $('#perfilLocalidade').val(),
            perfilAvatar: $('#perfilAvatar').val()
        },
        success: function (result) {
            fillTableUtilizador();
        }
...
//--------------------------------------------FUN합ES DE UTILIZADOR NO PERFIL-----------------------------------------//
...
function EliminaTableUtilizador() { // vai buscar o ID injectado e faz o DELETE
    $('#staticBackdropDele').modal('toggle');
    $.ajax({
        url: "../AJAX/AJAXDeleteUtilizador.php",
        type: "post",
